...
interface KafkaSupport {
    ...
    static void setupKafka(DynamicPropertyRegistry propertyRegistry) {
        ...
        propertyRegistry.add("kafka.tickets.bootstrapServers", KAFKA_CONTAINER::getBootstrapServers);
        propertyRegistry.add("kafka.seats.bootstrapServers", KAFKA_CONTAINER::getBootstrapServers);
        createTopic("tickets-topic");
        createTopic("seats-topic");
    }
